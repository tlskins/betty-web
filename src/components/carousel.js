  ...
  return (
    <div>
      <ul
        ...
        style={{ transform: `translateX(-40%)`, transition: `transform 350ms` }}
      >
        {items &&
          items.map((item, i) => {
  ...
  return (
    <div>
      <div
        ...
        style={{ minWidth: `45rem`, minHeight: `12rem` }}
      >
        <div
        ...
        >
          <img
            ...
            src="https://gritdaily.com/wp-content/uploads/2019/03/nfl-field-logo.jpg"
            alt=""
          />
        ...
        <div className="w-full md:w-3/5 h-full flex items-center bg-gray-100 rounded-lg">
          <div className="p-12 md:pr-24 md:pl-16 md:py-12">
            ...
            >
              <span className="text-gray-900">Game Time:&nbsp;</span>
              {item &&
                moment(item.gameTime, "YYYY-MM-DD HH:mm:ss Z").format(
                  "MMM Do YYYY, h:mm a"
                )}
              <br />
              <span className="text-gray-900">Game Reults At:&nbsp;</span>
              {item &&
                moment(item.gameResultsAt, "YYYY-MM-DD HH:mm:ss Z").format(
                  "MMM Do YYYY, h:mm a"
                )}
              <br />
            </p>
